...
{
    /**
     * The value of one Placeholder::ML_... constants that identifies which environment value is missing.
     *
     * @var string
     */
     ...
     *
     * @param string $environmentValueIdentifier the value of one Placeholder::ML_... constants that identifies which environment value is missing
     */
    public function __construct(string $environmentValueIdentifier)
    {
        switch ($environmentValueIdentifier) {
    ...
    /**
     * Get the value of one Placeholder::ML_... constants that identifies which environment value is missing.
     */
